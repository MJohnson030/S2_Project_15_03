...
// An event listener which loads an anonymous function. Inside the function onblur events are created for the elements that called/
window.addEventListener("load", function () {
  ...
  // When the Submit Button is clicked, this runs the sessionTest function.
  document.getElementById("regSubmit").onclick = sessionTest;

});


//The function sessionTest is used to provide a validation test for conference session selectionlist.
...
//The calcCart function is used to calculate the registration cost and to save the customer's infromation so that it isn't gone when the server is left. 
function calcCart() {
...
function writeSessionValues() {
   ...
   // Displays the total amount of all of the values from the session storage
